...
type Harness interface {
	...
	StartInitialTurn(context.Context, provider.Ownership, string, string, string, string, string, bool) (core.HarnessBinding, error)
	...
	StartTurn(context.Context, provider.Ownership, string, string, string, string, string, string, bool) (core.HarnessBinding, error)
