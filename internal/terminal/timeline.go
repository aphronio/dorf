...
func (e Externals) ReadTimeline(ctx context.Context, job core.Job, owned core.Sandbox, threadID, turnID string) (core.HarnessTimeline, error) {
	reader, ok := e.Agent.(TimelineHarness)
	if !ok || owned.JobID != job.ID {
