...
- **Decision history:** Accepted, 2026-09-10. D115 broadens the generic file API beyond workspace-root writes. D121 separates immutable application instructions from user workspace customization.
